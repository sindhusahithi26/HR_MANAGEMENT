...
public class Application {
    ...
    private void initialize() {
        ...
        lblNewLabel_20.setIcon(new ImageIcon("D:\\Project\\train.gif"));
        ...
        lblNewLabel_5.setIcon(new ImageIcon("D:\\Project\\gif.gif"));
        ...
        label.setIcon(new ImageIcon("D:\\Project\\test (1).jpeg"));
        ...
        lblNewLabel_19.setIcon(new ImageIcon("D:\\Project\\train.gif"));
        ...
        mntmNewMenuItem.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                try {
                    String url = "https://github.com/sindhusahithi26/HR_MANAGEMENT";
